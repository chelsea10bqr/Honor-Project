...
/* Getters for available and shared lists */
extern request_t * get_available();
extern request_t * get_shared();
...
int update (graph_t* g, heap_t* h, int32_t curr_idx, int32_t nb_arr_idx);
